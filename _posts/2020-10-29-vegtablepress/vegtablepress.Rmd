...
description: |
  A first presentation of vegtable and taxlist at the Marsaryk University in
  Brno (Czech Republic).
  The presentation includes a brief intorduction to the structure of vegtable
...
A presentation about the basics of the package
[`vegtable`](https://github.com/kamapu/vegtable) and
[`taxlist`](https://docs.ropensci.org/taxlist/).

The packages can be installed either from **CRAN** (last release) or **GitHub**
...
You can open the vignette installed for `taxlist` by calling it at the
R-console.
